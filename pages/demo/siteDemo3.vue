<template lang="pug">
.wrapper
  lv3-envmap-1(:img-list='imgList' :page-move='pageMove')
  .inner#inner-1
  ...
  .inner#inner-4
    ...
    .inner__wrapper
      div コンテンツ内容
  .inner#inner-5
    .inner__title コンテンツ見出し5
    .inner__wrapper
      div コンテンツ内容
  .inner#inner-6
    .inner__title コンテンツ見出し6
    .inner__wrapper
      div コンテンツ内容
  ...
  data() {
    return {
      imgList: [
        ...
        // "/images/demo-1/200x200-2.png",
        // "/images/demo-1/200x200-5.png",
        // "/images/demo-1/200x200-1.png",
      ],
      pageMove: false,
    }
  },
